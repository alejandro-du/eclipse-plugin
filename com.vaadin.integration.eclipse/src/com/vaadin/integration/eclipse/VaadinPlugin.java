...
public class VaadinPlugin extends AbstractUIPlugin {
    ...
    public static final String NEW_PLATFORM_MAVEN_PROJECT_WIZARD_BANNER_IMAGE_ID = "icons.new-platform-maven-project-wizard-banner";
    ...
    protected void initializeImageRegistry(ImageRegistry registry) {
        ...
        path = new Path("icons/flow-logo-64.png");
        url = FileLocator.find(bundle, path, null);
        desc = ImageDescriptor.createFromURL(url);
        registry.put(NEW_PLATFORM_MAVEN_PROJECT_WIZARD_BANNER_IMAGE_ID, desc);
    }
